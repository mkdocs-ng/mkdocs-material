...
```
git clone git@github.com:mkdocs-ng/mkdocs-material-insiders.git mkdocs-material
```
...
```
  ...
  [Fork the Insiders repository]: https://github.com/mkdocs-ng/mkdocs-material-insiders/fork
  ...
  [build]: https://github.com/mkdocs-ng/mkdocs-material-insiders/blob/master/.github/workflows/build.yml
...
```
  ...
  [configuration inheritance]: https://mkdocs-ng.github.io/mkdocs/user-guide/configuration/#configuration-inheritance
